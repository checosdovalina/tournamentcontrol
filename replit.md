...
-   **Upcoming Matches Scroll Animation Speed**: Set to 120 seconds per cycle for comfortable readability without rushing content, allowing viewers to properly read all upcoming match details.
